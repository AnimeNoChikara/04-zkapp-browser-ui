...
/***/ (function(__unused_webpack_module, __unused_webpack_exports, __webpack_require__) {
    ...
    (window.__NEXT_P = window.__NEXT_P || []).push([
      "/",
      function () {
        return __webpack_require__(8495);
      }
    ]);
    if(false) {}
...
;// CONCATENATED MODULE: ./pages/components/navbar.tsx
...
function Home() {
    (0,react.useEffect)(()=>{
        (async ()=>{
            ...
            const zkAppInstance = new Add(web/* PublicKey.fromBase58 */.nh.fromBase58(zkAppAddress));
        })();
    }, []);
